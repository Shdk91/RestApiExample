...
public class GetAllTest extends AbstractTest {
  ...
  public void getAllWithoutFiltersReturnAllPlayers() throws Exception {
    ...
    assertEquals("Возвращается не правильный результат при запросе GET /rest/players.", expected,
        actual);
  }
  ...
  public void getAllWithFiltersNamePageNumber() throws Exception {
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами name и pageNumber.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersTitlePageSize() throws Exception {
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами title и pageSize.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersRaceProfessionAfterBefore() throws Exception {
    ...
    ResultActions resultActions = mockMvc.perform(
        get("/rest/players?race=HUMAN&profession=WARRIOR&after=1041372000000&before=1136066400000"))
        .andExpect(status().isOk());
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами race, profession, after и before.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersRaceProfessionMinExperienceMaxExperience() throws Exception {
    ResultActions resultActions = mockMvc.perform(
        get("/rest/players?race=ELF&profession=SORCERER&minExperience=50000&maxExperience=150000"))
        .andExpect(status().isOk());
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами race, minExperience и maxExperience.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersBannedMinLevelMaxLevel() throws Exception {
    ResultActions resultActions = mockMvc
        .perform(get("/rest/players?banned=false&minLevel=10&maxLevel=30"))
        .andExpect(status().isOk());
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами banned, minLevel и maxLevel.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersBannedMaxLevel() throws Exception {
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами banned и maxLevel.",
        expected, actual);
  }
  ...
  public void getAllWithFiltersAfterBeforeMinExperienceMaxExperience() throws Exception {
    ...
    ResultActions resultActions = mockMvc.perform(
        get("/rest/players?after=1104530400000&before=1230760800000&minExperience=30000&maxExperience=100000&pageNumber=1"))
        .andExpect(status().isOk());
    ...
    assertEquals(
        "Возвращается не правильный результат при запросе GET /rest/players с параметрами after, before, minExperience и maxExperience.",
        expected, actual);
  }
}