...
public class PlayerInfoTest {
  ...
  public PlayerInfoTest(Long id, String name, String title, Race race, Profession profession,
      Long birthday,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, title, race, profession, birthday, banned, experience, level,
        untilNextLevel);
  }

  @Override
  public String toString() {
    LocalDate birthday = Instant.ofEpochMilli(this.birthday).atZone(ZoneId.systemDefault())
        .toLocalDate();
