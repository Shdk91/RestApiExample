...
public class GetCountTest extends AbstractTest {
  ...
  public void getCountWithoutFiltersReturnAllPlayers() throws Exception {
    ...
    assertSame("Возвращается не правильный результат при запросе GET /rest/players/count.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersMinLevelMinExperience() throws Exception {
    ResultActions resultActions = this.mockMvc
        .perform(get("/rest/players/count?minLevel=42&minExperience=94000")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET /rest/players/count с параметрами minLevel и minExperience.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersNameAfterMaxLevel() throws Exception {
    ...
    ResultActions resultActions = this.mockMvc
        .perform(get("/rest/players/count?name=ри&after=1104530400000&maxLevel=40")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET /rest/players/count с параметрами name, after и maxLevel.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersRaceProfessionBanned() throws Exception {
    ResultActions resultActions = this.mockMvc
        .perform(get("/rest/players/count?race=DWARF&profession=CLERIC&banned=true")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET rest/players/count с параметрами race, profession и banned.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersRaceProfessionMaxExperience() throws Exception {
    ResultActions resultActions = this.mockMvc
        .perform(get("/rest/players/count?race=TROLL&profession=WARRIOR&maxExperience=120000")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET /rest/players/count с параметрами race, profession и maxExperience.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersTitle() throws Exception {
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET /rest/players/count с параметром title.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersRaceProfessionBefore() throws Exception {
    ...
    ResultActions resultActions = this.mockMvc
        .perform(get("/rest/players/count?race=GIANT&profession=WARRIOR&before=1199138400000")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    ...
    assertSame(
        "Возвращается не правильный результат при запросе GET /rest/players/count с параметрами race, profession и before.",
        expected, actual);
  }
  ...
  public void getCountWithFiltersBanned() throws Exception {
    ...
    assertSame(
        "Во звращается не правильный результат при запросе GET /rest/players/count с параметром banned.",
        expected, actual);
  }
}